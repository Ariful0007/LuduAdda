...
public class Register2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cirLoginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (TextUtils.isEmpty(editTextPassword111.getText().toString())||TextUtils.isEmpty(edtname.getText().toString())
                    ...
                    if (!checkle.isChecked()) {
                        Toasty.error(getApplicationContext(), "Check you are over 18", Toast.LENGTH_SHORT, true).show();
                        return;
                    }
                    else {
    ...
    private void storeToFirestore1(final String name, final String toString, String image22, final String email) {
        ...
        userMap.put("email",username.getText().toString().toLowerCase()+"@gmail.com");
