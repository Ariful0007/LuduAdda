...
public class LotteryModel {
    ...
    String lottery_prize,lottery_baki_ase , time,image;

    public LotteryModel(String lottery_name, String lottery_Price, String lottery_prize, String lottery_baki_ase, String time, String image) {
