        ...
        upgrade.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(spinner1.getText().toString()) || TextUtils.isEmpty(spinner2.getText().toString()) ||
                    ...
                    if (valueFromSpinner.equals("Select Payment Methode")) {
                        Toasty.error(getApplicationContext(), "Select a payment methode.", Toasty.LENGTH_SHORT).show();
                        return;
                    } else if (b < 100||b>25000) {
                        kProgressHUD.dismiss();
                        Toasty.info(getApplicationContext(), "Payment range is 100 to 25000 ", Toasty.LENGTH_SHORT, true).show();
                    } else {
                        if (a >= b) {
                                                            ...
                                                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                                if (task.isSuccessful()) {
                                                                    if (task.getResult().exists()) {
                                                                        ...
                                                                        String getingUser = task.getResult().getString("username");
                                                                                                                            ...
                                                                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                                ...
                                                                                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                                                                                    if (task.isSuccessful()) {
                                                                                                                                        ...
                                                                                                                                        kProgressHUD.dismiss();
                                                                                                                                        kProgressHUD.dismiss();
                                                                                                                                        Toasty.success(getApplicationContext(), "Coin Withdraw Request Successfully Done", Toast.LENGTH_SHORT, true).show();
                                                                                                                                    }
                                                                                                                                }
                                                                                                                            });
                                                                                                                }
